...
resource "aws_lambda_function" "site" {
  function_name = "workassistance-site-${var.environment}"
...
#  function_name = "workassistance-employee-${var.environment}"
#  role          = aws_iam_role.lambda_exec.arn
#  handler       = "bootstrap"
#  runtime       = "provided.al2023"
...
#  function_name = "workassistance-attendance-${var.environment}"
#  role          = aws_iam_role.lambda_exec.arn
#  handler       = "bootstrap"
#  runtime       = "provided.al2023"
...
#  function_name = "workassistance-location-ingest-${var.environment}"
#  role          = aws_iam_role.lambda_exec.arn
#  handler       = "bootstrap"
#  runtime       = "provided.al2023"
